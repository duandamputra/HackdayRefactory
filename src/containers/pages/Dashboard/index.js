...
class Dashboard extends Component {
    ...
    render(){
        ...
        const {handleUpdateNotes, cancelUpdate, deleteNotes} = this
        console.log('notes: ', notes)
        return(
            <div className='container'>
                <div className='input-form'>
                    <input placeholder='title' className='input-title' value={title} onChange={(e) => this.onInputChange(e, 'title')}/>
                    <textarea defaultValue='content' className='input-content' value={content} onChange={(e) => this.onInputChange(e, 'content')}/>
                        ...
                        <Fragment>
                            {
                                notes.map(note => {
                                    return (
                                        <div className='card-content' key={note.id} onClick={() => handleUpdateNotes(note)}>
